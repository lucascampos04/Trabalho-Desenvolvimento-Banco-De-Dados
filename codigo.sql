...
DROP TABLE CONTRATAR_FUNCIONARIO;
...
CREATE TABLE EVENTOS_FORMATURA (
    ...
    EVENTO_FECH VARCHAR(30) NOT NULL,
    LIMIT_PESSOAS INT NOT NULL,
...
INSERT INTO EVENTOS_FORMATURA (ID, ID_FORMATURA, ID_EVENTO, DESCRICAO, LOCAL, DURACAO, DATA, STATUS, NOVA_DATA, EVENTO_FECH, LIMIT_PESSOAS)
VALUES (1, 1, 2, 'Descrição do Evento', 'RUA XX', '10 HRS', TO_DATE('21/10/2023', 'DD/MM/YYYY'), 1, 'SIM', '21/10/2023', 200);
...
INSERT INTO EVENTOS_FORMATURA (ID, ID_FORMATURA, ID_EVENTO, DESCRICAO, LOCAL, DURACAO, DATA, STATUS, NOVA_DATA, EVENTO_FECH, LIMIT_PESSOAS)
VALUES (5, 5, 5, 'Viagem até Minas gerais', 'RUA ABC', '1 Mês', TO_DATE('30/11/2023', 'DD/MM/YYYY'), 1, 'SIM', '30/1/2023', 200);
-- SELECT
